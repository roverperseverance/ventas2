...
$celular = $_REQUEST['txtcelular'];
 ?>
  <div id="page-wrapper">
         ...
         <?php 							
            $sSQL="Update usuario Set nombres_u='$nombres',apellidos_u='$apellidos',celular_u='$celular' where idusuario=$idusu";
     
            if (execute($sSQL) or die (mysqli_error())) {
                ?>
                      <div class="alert alert-info">
                El registro se actualizo correctamente.<a href="principal_p.php" class="alert-link">Ver</a>.
            </div>
                <?php
            }else{
                  ?>
